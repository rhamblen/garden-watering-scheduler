...
| v0.6.2 | ✅ | Countdown now includes the settle gaps (accurate "Time remaining"); install guide gains a Claude "add a second schedule" prompt |
| v0.7.0 | ✅ | Arm-state persistence — Go/Disarm toggle; intent helper + startup automation restores armed state after HA reboot; Stop no longer disarms |
| v0.7.1 | ✅ | Fix: Winterise correctly disarms and clears arm intent (schedule stays off across reboots during winter) |
